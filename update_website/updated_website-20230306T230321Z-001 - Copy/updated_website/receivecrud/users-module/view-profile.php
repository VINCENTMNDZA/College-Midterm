...
<form method="POST" action="processes/process.user.php?action=update">
        <div id="form-block-half">
            ...
            <input type="text" id="fname" class="input" name="firstname" value="<?php echo $user->get_user_firstname($id);?>" placeholder="Enter First Name">

            <label for="lname">Last Name</label>
            <input type="text" id="lname" class="input" name="lastname" value="<?php echo $user->get_user_lastname($id);?>" placeholder="Enter Last Name">

            <label for="access">Address</label>
            <input type="text" id="access" class="input" name="access" value="<?php echo $user->get_user_status($id);?> "placeholder="Email/Contact...">
            </select>
        </div>
