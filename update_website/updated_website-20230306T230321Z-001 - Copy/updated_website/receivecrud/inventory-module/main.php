...
?>
      <tr>
        ...
        <td style="text-align: right;"><?php echo number_format($product->get_prod_price($prod_id) * ($inventory->get_product_receive_inv($prod_id) - $inventory->get_product_release_inv($prod_id)),2);?></td>
      </tr>
      <tr>
<?php
 $count++;
