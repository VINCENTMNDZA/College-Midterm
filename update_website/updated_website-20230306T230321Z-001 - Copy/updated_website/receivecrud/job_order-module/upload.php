...
if ($file_ext == 'jpg' || $file_ext == 'jpeg') {
    ...
    $image = imagecreatefromgif($upload_dir . $uniq_name);
} else {
...
if ($file_ext == 'jpg' || $file_ext == 'jpeg') {
    ...
    imagegif($resized_image, $upload_dir . $id."_" . $uniq_name);
}
...
// Add to database
$JO->update_product_img($id."_".$uniq_name,$id);
// Display success message
//echo "Image uploaded successfully.";

header("location: ../index.php?page=job_order-module&subpage=action=types&id=".$id);