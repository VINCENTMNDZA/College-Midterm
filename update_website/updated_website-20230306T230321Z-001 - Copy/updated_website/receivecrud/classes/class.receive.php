...
class Receive{
	...
	public function new_receive($sname,$desc,$amount){
		...
		$stmt = $this->conn->prepare("INSERT INTO tbl_receive(rec_supplier, rec_description, rec_amount, rec_date_added, rec_time_added, rec_status) VALUES (?,?,?,?,?,?)");
		try {
